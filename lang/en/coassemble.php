...
$string['flow_help'] = 'Choose how the builder should open the first time: start from scratch or generate with AI. You can switch between these flows from the activity page before a Coassemble course is linked.';
